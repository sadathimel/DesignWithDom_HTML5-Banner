		...
		(function setup(){
			...
			function _createControls(){
				if(_settings.rotationDirection == 'ltr'){
					_previousButton = $( "<div class='previous controls' style='left: -3px;'><img src=''</div>");
					_nextButton = $( "<div class='next controls' style='right: right: -3px;'><img src=''</div>");
				}else{
					_previousButton = $( "<div class='previous controls' style='left:-3px;'><img src=''</div>");
					_nextButton = $( "<div class='next controls' style='right:-3px;'><img src=''</div>");
				}
